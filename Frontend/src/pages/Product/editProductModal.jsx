  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updatedProduct = {
        name: formData.name,
        image: imageUrl,
        productDetails: formData.description,
      ...
      const response = await fetch(
        `${API_ROUTES.PRODUCT.UPDATE_PRODUCT}/${product._id}`,
        {
          method: "PUT",
          headers: {
      ...
      if (response.ok) {
        ...
        const finalUpdatedProduct = { ...product, ...updatedProduct };
        onProductUpdate(finalUpdatedProduct);
